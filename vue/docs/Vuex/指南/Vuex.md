...
[安装](https://vuex.vuejs.org/zh/installation.html) Vuex 之后，让我们来创建一个 store。创建过程直截了当——仅需要提供一个初始 state 对象和一些mutation：
...
这是一个[最基本的 Vuex 记数应用 (opens new window)](https://jsfiddle.net/n9jmu5v7/1269/)示例。
...
创建以下 wbpack 配置（配置好 [`.babelrc` (opens new window)](https://babeljs.io/docs/usage/babelrc/)）:
