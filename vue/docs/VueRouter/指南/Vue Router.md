...
可以看看这个[在线例子 (opens new window)](https://jsfiddle.net/yyx990803/4xfa2f19/)。
...
提供以上案例的可运行代码请[移步这里 (opens new window)](https://jsfiddle.net/yyx990803/L7hscd8h/)。
...
完整的例子请[移步这里 (opens new window)](https://github.com/vuejs/vue-router/blob/dev/examples/named-routes/app.js)。
...
以上案例相关的可运行代码请[移步这里 (opens new window)](https://jsfiddle.net/posva/6du90epg/)。
...
一个可以工作的示例的 demo 在[这里 (opens new window)](https://jsfiddle.net/posva/22wgksa3/)。
...
更多高级用法，请查看[例子 (opens new window)](https://github.com/vuejs/vue-router/blob/dev/examples/route-props/app.js)。
...
或者，如果你使用 Node.js 服务器，你可以用服务端路由匹配到来的 URL，并在没有匹配到路由的时候返回 404，以实现回退。更多详情请查阅 [Vue 服务端渲染文档 (opens new window)](https://ssr.vuejs.org/zh/)。
...
查看完整例子请[移步这里 (opens new window)](https://github.com/vuejs/vue-router/blob/dev/examples/transitions/app.js)。
