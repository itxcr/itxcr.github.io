...
- Props
  ...
  - name - string 用于自动生成 CSS 过渡类名。例如： `name: 'fade'` 将自动扩展为`.fade-enter`,`.fade-enter-active` 等。默认类名为 "v"。
...
- 用法
  ...
  - [过渡：进入，离开和列表](https://cn.vuejs.org/v2/guide/transitions.html)
...
## [VNode 接口](https://cn.vuejs.org/v2/api/#VNode-接口)

## [服务端渲染](https://cn.vuejs.org/v2/api/#服务端渲染)
