<template>
  <div class="message-input" v-if="activeRoom">
      ...
      <template slot="content">
        <a-tabs default-key="1" size="small">
          <a-tab-pane key="1" tab="Emoji">
            <general-emoji @addEmoji="addEmoji"></general-emoji>
          </a-tab-pane>
    ...
    <a-input autocomplete="off" type="text" placeholder="say hello..." v-model="text" ref="input" autoFocus style="color: #000" @pressEnter="throttle(preSendMessage)" />
...
import GeneralEmoji from '@/components/GeneralEmoji.vue'
...
export default class GeneralInput extends Vue {
